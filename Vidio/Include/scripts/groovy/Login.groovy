...
class Login {
	...
	@Given("I want to open vidio.com for (.*)")
	def I_want_to_open_vidio_for(String row) {
	...
	@When("I login")
	def I_login() {
		WebUI.callTestCase(findTestCase('Login/Login Maker'), [:], FailureHandling.STOP_ON_FAILURE)
	}
}