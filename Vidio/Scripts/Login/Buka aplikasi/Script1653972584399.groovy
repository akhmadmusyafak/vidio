...
WebUI.comment(GlobalVariable.dirProject)
...
String dateToday = today.format('MM_dd_yy')

String timeNow = today.format('hh_mm_ss')

GlobalVariable.todayDate = dateToday

GlobalVariable.nowTime = timeNow
